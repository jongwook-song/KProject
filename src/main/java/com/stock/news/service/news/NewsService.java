...
import com.stock.news.domain.news.NewsRepositorySupport;
...
public class NewsService {
    ...
    // [J0004] Start
    public Page<News> findBySearchdate( NewsListRequestDto newsListRequestDto){
        Page<News> newsLists = null;
        Predicate searchCondition = null;

        Pageable paging = PageRequest.of( newsListRequestDto.getCurrentPage(), 10, new Sort(Sort.Direction.DESC, "view"));

        searchCondition = newsRepositorySupport.findBySearchdate( newsListRequestDto.getSearchdate());

//        List<NewsListResponseDto> reulsts =  newsRepository.findBySearchdate( date).stream()
...
//                .collect(Collectors.toList());
    ...
    public Page<News> searchNewsDetail( NewsListRequestDto newsListRequestDto){
        ...
        searchCondition = newsRepositorySupport.searchNewsDetail( newsListRequestDto.getSearchdate(), newsListRequestDto.getSearchText());
